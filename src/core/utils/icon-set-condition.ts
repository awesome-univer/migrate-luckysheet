import { generateRandomId, get } from "@univerjs/core";
import { IDataBar, CFRuleType, CFValueType, IIconSet, CFNumberOperator } from "@univerjs/sheets-conditional-formatting";
import { IluckysheetCFIconsFormat, IluckysheetConditionFormat } from "../../common/interface/condition-format";
